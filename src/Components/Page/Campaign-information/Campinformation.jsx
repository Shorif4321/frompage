...
const Campinformation = () => {
   ...
   /*  const subIDs = [
        { tittle: 'Sub ID: 1',button:'handleSubID1'},
        { tittle: 'Sub ID: 2',button:'handleSubID2'},
        { tittle: 'Sub ID: 3',button:'handleSubID3'},
        { tittle: 'Sub ID: 4',button:'handleSubID4'},
        { tittle: 'Sub ID: 5',button:'handleSubID5'},
        { tittle: 'Sub ID: 6',button:'handleSubID6'}
    ] */

    const copyToClipboard = (elementId) => {
        const text = document.getElementById('myCopy').innerHTML;
        navigator.clipboard
          .writeText(text)
          .then(() => {
                    ...
                    <div className='res-sear right-side '>
                        ...
                        <div className='camp-details link-generate'>
                            <div className='link-url '>
                                <p id='myCopy'>https://micple.com/signup https://micple.</p>
                            </div>
                            <div className='link-copy'>
                                <a onClick={copyToClipboard} className='res-details copy-icon'><i className="fas fa-clone"></i> Copy Link </a>
                            </div>
                        </div>
                        ...
                        <div className='traffic-select'>
                           ...
                           {/*  {
                                subIDs.map(subID=><div className='subid-add'>
                                <label htmlFor="">{subID.tittle}</label>
                                <input onChange={subID.button} type="text" />
                            </div>)
                            } */}
